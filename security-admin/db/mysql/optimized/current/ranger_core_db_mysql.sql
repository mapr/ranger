...
CREATE TABLE `x_portal_user` (
  ...
  `other_attributes` MEDIUMTEXT DEFAULT NULL,
  `sync_source` MEDIUMTEXT DEFAULT NULL,
...
`policy_options` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_ref_resource` (
  ...
  `resource_name` MEDIUMTEXT DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `x_policy_ref_access_type` (
  ...
  `access_type_name` MEDIUMTEXT DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `x_policy_ref_condition` (
  ...
  `condition_name` MEDIUMTEXT DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `x_policy_ref_datamask_type` (
  ...
  `datamask_type_name` MEDIUMTEXT DEFAULT NULL,
  PRIMARY KEY (`id`),
