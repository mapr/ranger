...
policy_options CLOB DEFAULT NULL NULL,
...
config_value CLOB DEFAULT NULL NULL,
primary key (id),
...
resource_name CLOB DEFAULT NULL NULL,
primary key (id),
...
access_type_name CLOB DEFAULT NULL NULL,
primary key (id),
...
condition_name CLOB DEFAULT NULL NULL,
primary key (id),
...
datamask_type_name CLOB DEFAULT NULL NULL,
primary key (id),
...
policy_id NUMBER(20) NOT NULL,
user_id NUMBER(20) NOT NULL,
user_name CLOB DEFAULT NULL NULL,
primary key (id),
...
group_name CLOB DEFAULT NULL NULL,
primary key (id),
...
name varchar(255) NOT NULL,
description varchar(1024) DEFAULT NULL NULL,
role_options CLOB DEFAULT NULL NULL,
