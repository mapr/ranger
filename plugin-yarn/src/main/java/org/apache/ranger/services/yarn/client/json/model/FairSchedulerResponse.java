...
public class FairSchedulerResponse implements java.io.Serializable, SchedulerResponse {
    ...
    public static class YarnSchedulerInfo implements java.io.Serializable {
        ...
        public void collectQueueNames(List<String> queueNames) {
            if (rootQueue != null) {
                rootQueue.collectQueueNames(queueNames, true);
            }
        }
    }
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.FIELD)
    public static class YarnRootQueue implements java.io.Serializable {
        private static final long serialVersionUID = 1L;
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.FIELD)
    public static class YarnChildQueues implements java.io.Serializable {
        private static final long serialVersionUID = 1L;
        ...
        public void collectQueueNames(List<String> queueNames) {
            if (queue != null) {
                for (YarnRootQueue schedulerInfo : queue) {
